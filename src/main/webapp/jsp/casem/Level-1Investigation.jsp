...
<div class="row">
   <div class="col-12 grid-margin stretch-card">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title">Level-1 Investigation</h4>
...
$(document).ready(function () {
   $("#src_sys_id").change(function() {
	   //alert("inside");
		var sys_id = $(this).val();
		//alert(sys_id);
		$.post('/casem/viewCtryList1', {
			sys_id : sys_id
		}, function(data) {
			$('#loadCountryInfo1').html(data)
		});
	})
...
<div class="form-group row">
	...
	<select name="src_sys_id" id="src_sys_id" class="form-control form-control1">
		...
		<c:forEach items="${viewSSID1}" var="fileId">
