  ...
  <div class="main main-raised">
    <div class="profile-content">
      <div class="container">
			<br>
			<div class="name">
                <h2 class="title" align="center">Register Feed</h2>
            </div>
        ...
        <!-- <div class="tab-content tab-space">
					<div class="tab-pane active text-center gallery" id="studio">
						<div class="row">
							...
							<div class="col-md-4">
								<img src="./material/img/downloadarrow.png" alt="Image"
									height="10" width="10" class="material-icons">
								<h4 class="info-title">Download Template</h4>
			...
			<div class="col-12 grid-margin stretch-card">
						<div class="card">
						  ...
						  <div class="input-group-prepend">
						    <span style="height: 38px" class="input-group-text" id="inputGroupFileAddon01">Upload</span>
						  </div>
